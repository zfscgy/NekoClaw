...
from nekoclaw.config.schema import TelegramConfig
from nekoclaw.utils.helpers import split_message
...
class TelegramChannel(BaseChannel):
    ...
    async def deliver(self, msg: OutboundMessage) -> None:
        ...
        # Send text content
        content = msg.msg.content if msg.msg else ""
        ...
        if media_file and self._app:
            try:
                ...
                if media_type == "voice" or media_type == "audio":
                    from nekoclaw.providers.transcription import GroqTranscriptionProvider
